...
description: "Let's get started learning to use dartR  ! A hands on guide"
---
...
```{r ex21a, exercise = TRUE, exercise.setup = "data4"}
x <- 12
class(x)
```
