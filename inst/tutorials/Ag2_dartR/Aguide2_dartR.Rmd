...
gl <- gl.load("./www/Tympo_SNP_filtered.RData")
...
m<-leaflet() %>% addCircles(lng = gl@other$latlon$lon,
                         lat = gl@other$latlon$lat,
                         color = c('red', 'blue','green', 'yellow')[as.numeric(gl@pop)]) %>% 
...
- Exercise 5-1: Filtering SNP Data

- Exercise 5-2: Filtering SilicoDArT Data

Chapter 6 Exercises

- Exercise 6-1: Visualizing Structure
